...
Title.Text = "TR PRISON LIFE SCRIPT BY GSCRIPTS"
...
TaseBypass.Text = "ŞOK ENGELLEYİCİ"
...
Btools.Text = "IŞE YARAYAN TOOLLAR"
...
TextButton.Text = "SUÇLU OL (KILL AURA AÇ)"
...
NexusTPbut.Text = "NEXSUS'A TELEPORT OL"
...
CrimBaseTPbut.Text = "SUÇLU YERINE IŞINLAN"
...
GuardAreaTPbut.Text = "GARDIYAN ARENASINA IŞINLAN"
...
Njump.Text = "NORMAL ZIPLAMA HIZI"
...
tfJump.Text = "+25 ZIPLAMA GUCU ARTTIR"
...
TheLocal.Text = "DAHA FAZLA LOCAL KOMUTLAR"
...
CrimG.Text = "SUÇLU OYUNCUYA ODAKLAN"
...
InsertUserTP.Text = "KULLANICI ADI"
...
ArrestAll.Text = "HERKESİ TUTUKLA"
...
InvGuns.Text = "TURN GUNS INVIS (İlk önce çözün)"
...
CrimPunch.Text = "EŞYALARI KALDIR"
...
Credit.Text = "GSCRİPTS TARAFINDAN Prison Life Scripti"
...
Dino.Text = "Bu GUI, ÜCRETSİZ istismarlarda en iyisi değildir. Esas olarak Visenya, Synapse, vb. gibi ücretli istismarlar içindir. Bununla birlikte ücretsiz bir lua yürütücüsü kullanıyorsanız, bir şey doğru çalışmazsa şaşırmayın, lütfen bunu 'https://pastebin.com/JS5SYqaU' olmayan kendi bağlantısıyla yükleyen biri varsa, o zaman benim berbat GUI'min en yeni sürümünü alamayacaksınız, ama yine de, iyi şanslar ve bununla eğlenin sanırım."
...
TeamOPorCL.Text = "Aç/Kapat TAKIM GUI'SİNDE KAL"
...
TextLabel_2.Text = "Ekipte Kal GUI"
...
SOG.Text = "Muhafız takımında kal!"
...
SOC.Text = "Suçlular takımında kal!"
...
SOI.Text = "Mahkumlar takımında kalın!"
...
Disable.Text = "Etkisiz Hale Getir"
