if IY_LOADED and not _G.IY_DEBUG == true then
     error("INFINITE YIELD Zaten Çalışıyor.", 0)
    return
end
...
if not game:IsLoaded() then
    ...
    notLoaded.Text = "Infinite Yield Oyunun Yüklenmesini Bekliyor."
    game.Loaded:Wait()
    notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Infinite Yield FE TR YAMA" .. currentVersion
...
SettingsHolder.VerticalScrollBarInset = 'Her Zaman'
...
ColorsButton = makeSettingsButton("Temayı Düzenle","rbxassetid://4911962991")
ColorsButton.Position = UDim2.new(0,5,0,55)
ColorsButton.Size = UDim2.new(1,-10,0,25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Tuşları Düzenle","rbxassetid://129697930")
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("İşlevleri Düzenle","rbxassetid://5147488658")
...
StayOpen.Text = "Menü Her Zaman Açık"
...
Positions = makeSettingsButton("Yol Noktalarını Düzenle/Git","rbxassetid://5147488592")
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Event Tuşlarını Düzenle","rbxassetid://5147695474",759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Pluginleri Düzenle","rbxassetid://5147695474",743)
...
Credits.Text = "Edge // Zwolf // Moon // Toon // GScripts"
...
Directions.Text = "Aşağıdaki düğmeye tıklayın ve bir tuşa/fare düğmesine basın. Ardından neye bağlamak istediğinizi seçin."
...
BindTo.Text = "Bağlamak için tıklayın"
...
BindTriggerSelect.Text = "Aşağı Tuş"
...
task.spawn(function()
	...
	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify('Sürüm Eski','GScripts Tarafından Güncellenecektir. Merak Etmeyin.')
		end
		...
		if latestVersionInfo.Announcement and latestVersionInfo.Announcement ~= '' then
			...
			PopupText.Font = Enum.Font.SourceSans
			PopupText.TextSize = 14
			PopupText.Text = "Sunucu Duyurusu"
			PopupText.TextColor3 = currentText1
			PopupText.TextWrapped = true
...
task.spawn(function()
	...
	minimizeHolder()
	if IsOnMobile then notify("Uyarı", "Mobil'de Sorun Yaşayabilirsiniz.") end
end)
